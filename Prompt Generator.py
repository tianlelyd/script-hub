...
load_dotenv()  # 这会加载 .env 文件中的所有环境变量

import openai, re
import os
OPENAI_API_KEY = os.getenv('OPENROUTER_API_KEY') # Put your API key here!
...
TASK = "Write AI tool review articles from a third-person perspective! Generate content by sections based on reference information and target language! Output format in markdown" # Replace with your task!
